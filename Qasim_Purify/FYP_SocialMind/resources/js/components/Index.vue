<template>
    ...
    <!-- <body class="bg-black body-clip">  BODY TAG IN BLADE FILE.--> 
      <!-- preloader -->
      <!-- <div class="preloader">
        <div class="preloader__img">
          <img src="../../../public/img/preloader-img.png" alt="image">
        </div>
      </div> -->
      <!-- preloader End -->
            ...
            <div class="col-xxl-5 col-xl-6 col-lg-8 col-md-10">
              <div class="gradient-card py-sm-12 py-8 px-sm-8 px-5 rounded-5">
                ...
                <form>
                  ...
                  <p class="mb-0 clr-neutral-80 text-center mt-8">Don't have an Account ? <a href="register.html" class="link clr-primary-key fw-semibold">Register</a></p>
                  <div class="text-center mt-6">
                    <a href="index.html" class="link d-inline-flex justify-content-center align-items-center gap-2 py-2 px-4 border border-primary-key bg-primary-key :bg-primary-30 rounded-pill fs-14 fw-bold text-center clr-white">
